...
void NsMonitoring::doSendMon(std::stringstream *os) {
	...
	uint16_t port = (uint16_t) NsSkelConfiguration::instance()->getParameter<int64_t>(
			CONFIG_PARAMNAME_NSMONITORING_PORT_UDP);
...
void
NsMonitoring::monitorSendRpcRequest(shared_ptr<string> remoteServiceName, std::shared_ptr<std::string> remoteMethod,
...
void NsMonitoring::monitorSendRpcRequestError(shared_ptr<string> remoteServiceName,
